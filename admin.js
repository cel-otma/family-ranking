...
// }
function saveRanking() {
  // Calculate the ranking before saving
  calculateRanking();
  ...
  database
    ...
    .then(() => {
      alert(
        "Ranking has been saved and is now available for members to view online."
      );
    })
    .catch((error) => {
      console.error("Error saving ranking: ", error);
      alert("An error occurred while saving the ranking. Please try again.");
    });
}
...
function exportToExcel() {
  ...
  try {
    ...
    alert(
      "Une erreur s'est produite lors de l'exportation. Veuillez vérifier la console pour plus de détails."
    );
  }
}
